...
class ParserModel(Model):
    ...
    def add_embedding(self):
        ...
        """
        ### YOUR CODE HERE
        embed_words = tf.Variable(self.pretrained_embeddings)
        embeddings = tf.reshape(tf.nn.embedding_lookup(embed_words, self.input_placeholder),
    ...
    def add_prediction_op(self):
        ...
        ### YOUR CODE HERE
        self.W = tf.Variable(xavier_weight_init()((self.config.n_features * self.config.embed_size,
                                     self.config.hidden_size)))
        self.U = tf.Variable(xavier_weight_init()((self.config.hidden_size, self.config.n_classes)))
